...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train U-Net regressor for dem_diff.")
...
def main() -> None:
    ...
    model_root = Path(args.model_root or output_cfg.get("model_dir", "models/unet"))
    run_dir = create_run_dir(model_root, prefix=output_cfg.get("run_prefix", "unet"))
